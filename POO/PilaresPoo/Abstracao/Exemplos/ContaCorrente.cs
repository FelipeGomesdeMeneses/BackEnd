namespace Exemplos
{
    public class ContaCorrente : ContaBancaria
    {
        ...
        public override double Depositar(double ValorDeposito)
        {
            ...
            {
              double Saldo3 = Saldo += ValorDeposito;
                Console.WriteLine($"O seu novo saldo é de R${Saldo3}");
                return Saldo3;
            }
        ...
        public override double Sacar(double ValorSaque)
        {
            ...
            {
             double Saldo4 = Saldo -= ValorSaque * Taxa;
                Console.WriteLine($"O seu novo saldo é de R${Saldo4}");
                return Saldo4;
            }
